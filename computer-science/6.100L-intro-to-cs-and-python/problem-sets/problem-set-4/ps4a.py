...
def is_heap(tree, compare_func):
    ...
    if left_child == None and right_child == None:
        ...
        return is_heap(right_child, compare_func) and compare_func(right_child.get_value(), tree.get_value())
    elif right_child == None:
        return is_heap(left_child, compare_func) and compare_func(left_child.get_value(), tree.get_value())
    else:
        return is_heap(left_child, compare_func) and is_heap(right_child, compare_func) and compare_func(left_child.get_value(), tree.get_value()) and compare_func(right_child.get_value(), tree.get_value())
